...
from ai_metaphors.common.core.utils.path_utils import process_temperature, process_working_dir, process_bin_directory
from ai_metaphors.common.core.utils.text_utils import extract_content, extract_json, extract_python_code
